...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create newspaper-9226
  fly apps create newspaper-9226-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app newspaper-9226
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app newspaper-9226-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'newspaper-9226-staging' does not match app name in config file 'newspaper-9226'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name newspaper-9226-db
  fly postgres attach --app newspaper-9226 newspaper-9226-db

  fly postgres create --name newspaper-9226-staging-db
  fly postgres attach --app newspaper-9226-staging newspaper-9226-staging-db
  ```
